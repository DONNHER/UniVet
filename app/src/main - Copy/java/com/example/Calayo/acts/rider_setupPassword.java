...
public class rider_setupPassword  extends AppCompatActivity {

    private static final String TAG = "Rider SetUpPasswordActivity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rider_set_password);
