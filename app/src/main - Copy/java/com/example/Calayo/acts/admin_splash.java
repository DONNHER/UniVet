...
public class admin_splash extends AppCompatActivity {
        ...
        if (data != null &&
            ...
            timeoutRunnable = () -> {
                if (progressBar.getVisibility() == View.VISIBLE) {
                    Toast.makeText(admin_splash.this,
                ...
                executor.execute(() -> {
                    try {
                        temp.loadAllData(() -> temp.loadAllUserData(() -> runOnUiThread(() -> {
                            ...
                            startActivity(new Intent(admin_splash.this, AdminDashB.class));
                            finish();
                        })));
                    } catch (Exception e) {
    ...
    private void redirectToLogin() {
        startActivity(new Intent(admin_splash.this, AdminLogin.class));
        finish();
    }
}
